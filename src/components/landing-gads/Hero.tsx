    ...
    <section style={{
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
        ...
        <div style={{
          ...
          <span style={{ width: 7, height: 7, borderRadius: "50%", background: "#4CAF50", animation: "pulse 2s infinite" }} />
          <span style={{ color: "var(--white)", fontSize: 12.5, fontWeight: 600, letterSpacing: 0.2 }}>Conoce las alternativas para optimizar tu crédito.</span>
        </div>
        ...
        <h1 style={{
          ...
          Optimiza tu crédito<br />
          <span style={{ position: "relative", display: "inline-block" }}>
            <span style={{ color: "var(--yellow)" }}>hipotecario</span>
        ...
        <p style={{
          ...
          Te asesoramos para implementar una estrategia inteligente de abonos a capital, orientada a reducir el plazo de tu crédito y generar ahorros significativos en el costo total de los intereses, de acuerdo con{" "}
          <strong style={{ color: "var(--yellow)", fontWeight: 800 }}>la normativa vigente</strong>.
        </p>
